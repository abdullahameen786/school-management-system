...
import { BookOpen, Clipboard, Save, AlertCircle, CheckCircle2, Lock, Plus, X } from 'lucide-react';
          ...
          <table className="min-w-full divide-y divide-slate-200">
            <thead className="bg-slate-50">
              <tr>
                ...
                <th className="px-6 py-4 text-right text-xs font-semibold text-slate-500 uppercase tracking-wider">Obtained Score</th>
              </tr>
            </thead>
            ...
            <form onSubmit={handleCreateExam} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Mid-1, Quiz 3, Viva..."
                />
              </div>
